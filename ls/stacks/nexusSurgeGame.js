...
function nexusSurge(actions) {
        ...
        if (!/\d/.test(action)) {
            switch (action) {
                case '-':
                    ...
                    break;
                case '+':
                    let num1 = scoreboard[scoreboard.length - 1];
                    let num2 = scoreboard[scoreboard.length - 2];
                    scoreboard.push(num1 + num2);
                    break;
                case '*':
                    let num = scoreboard[scoreboard.length - 1];
                    scoreboard.push(num * 2);
                    break;
            }
        } else {
    ...
    return scoreboard.reduce((a, b) => a += b, 0);
}
